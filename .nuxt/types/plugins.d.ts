...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../node_modules/nuxt-auth-sanctum/dist/runtime/plugin").default> &
  ...
  InjectionType<typeof import("../../plugins/1. chart.client").default> &
  InjectionType<typeof import("../../plugins/1. init.server").default> &
  InjectionType<typeof import("../../plugins/2. date-picker.client").default> &
  InjectionType<typeof import("../../plugins/2. format-number.server").default> &
  InjectionType<typeof import("../../plugins/3. format-number.client").default> &
  InjectionType<typeof import("../../plugins/4. vue3-toastify").default> &
  InjectionType<typeof import("../../plugins/5. ofetch.client").default>
