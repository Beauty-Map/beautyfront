import { defineComponent, ref, mergeProps, unref, withCtx, openBlock, createBlock, createVNode, useSSRContext, createTextVNode, watch } from "vue";
...
import { H as Header$2 } from "./Header-DQtllvZs.js";
import { f as useNuxtApp, _ as _export_sfc, u as useAuthStore, b as useRouter, e as useCookie } from "../server.mjs";
import { _ as _sfc_main$n } from "./MainActionButton-dCV7vShO.js";
import { _ as _sfc_main$m } from "./TelInput-Dce7UZL4.js";
import { a as _sfc_main$o, H as Header$5, _ as _sfc_main$v } from "./RegisterForm-B7P0ysQc.js";
import LoadingComponent from "./Loading-BdqMyNBb.js";
import { B as BackIcon } from "./BackIcon-nFKai1cn.js";
import { B as BeautyIcon, _ as _sfc_main$r } from "./BeautyIcon-B0tzcQSF.js";
import { H as Header$3, _ as _sfc_main$p } from "./Header-BOhVDNNd.js";
import { H as Header$4, _ as _sfc_main$q } from "./SecurityLinkBox-DBIJiCrA.js";
import { u as useSanctumAuth } from "./useSanctumAuth-B2JusLUJ.js";
import { u as useCustomFetch } from "./useCustomFetch-7ynZLwB1.js";
import { _ as _sfc_main$s, a as _sfc_main$t, b as _sfc_main$u, P as ProfileBigIcon } from "./BirthDateInput-BX9rvxsi.js";
import { _ as _sfc_main$w } from "./ProfileLink-CyK1DvW1.js";
import { L as LeftArrow } from "./LeftArrow-LWKoxjM1.js";
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const doSendCode = async () => {
      ...
      postRequest("/own/alt-number", form.value).then((res) => {
        app.$toast.success("کد با موفقیت ارسال شد", { rtl: true });
        openDrawerClicked();
      }).catch((err) => {
        const errors2 = Object.values(err.data.errors);
        for (const k in errors2) {
          for (const e in errors2[k]) {
            app.$toast.error(errors2[k][e], { rtl: true });
          }
        }
      });
    };
    const validate = async (code) => {
      putRequest("/own/alt-number", { code, alt_number: form.value.alt_number }).then((res) => {
...
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$p, { class: "mt-[17px]" }, null, _parent));
      _push(`</div></div>`);
    };
  }
});
...
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(BackIcon, { onClick: goBack }, null, _parent));
      _push(`</div>`);
      _push(ssrRenderComponent(_sfc_main$q, { class: "mt-8" }, null, _parent));
      _push(`</div>`);
    };
  }
});
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$v, { class: "mt-[17px]" }, null, _parent));
      _push(`</div></div>`);
    };
  }
});
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ProfileLink = _sfc_main$w;
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(user)) {
        ...
        _push(`<div class="flex flex-col justify-start items-start w-full cursor-pointer mr-[13px] text-black text-[20px] leading-[30px] text-right"><div class="font-medium mb-[10px] text-[14px] leading-[21px] text-[#000000]">${ssrInterpolate(unref(user).full_name ? unref(user).full_name : unref(user).email)}</div><div></div></div>`);
      }
      _push(`</div>`);
    };
  }
...
//# sourceMappingURL=SetPasswordDrawer-DqdRmVA7.js.map
