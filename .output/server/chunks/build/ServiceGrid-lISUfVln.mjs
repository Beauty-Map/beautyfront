import { _ as _sfc_main$1 } from './ServiceItem-BOQlzdWI.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid grid-cols-4 gap-x-2 gap-y-8 w-full" }, _attrs))}><!--[-->`);
...
//# sourceMappingURL=ServiceGrid-lISUfVln.mjs.map
