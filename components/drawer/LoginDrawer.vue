<template>
<div
    class="max-w-[425px] mx-auto flex flex-col top-0 bottom-0 px-[17px] overflow-y-scroll w-full duration-700 ease-in-out bg-white z-[99999999]"
    :class="[store.isOpenLogin ? 'absolute left-0' : 'fixed left-[-100%]']"
>
