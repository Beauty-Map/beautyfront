<template>
  <div class="flex flex-col items-start justify-start">
    ...
    >
      <input :type="showPassword ? 'text' : 'password'" class="text-left h-[38px] w-full rounded-[8px] outline-none focus:outline-none pl-[40px] pr-[20px] placeholder:text-[#A9A7A7]"
