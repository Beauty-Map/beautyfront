<template>
  <div class="w-full flex flex-col items-start justify-start main-desktop-slider">
    <PopularArtistDesktopSliderItem
      :image="slide.image"
...
import PopularArtistDesktopSliderItem from "~/components/main/PopularArtistDesktopSliderItem.vue";
const slide = {
