<template>
  <div class="w-full flex flex-col items-start justify-start">
    ...
    <div class="w-full mt-[10px] overflow-y-scroll h-[calc(100vh-210px)] relative">
      <div class="absolute top-0 bottom-0 w-full duration-700" :class="[province ? 'left-[-100%]' : 'left-0']">
      ...
      <div class="absolute top-0 bottom-0 w-full duration-700" :class="[province ? 'left-0' : 'left-[-100%]']">
