<template>
  <div class="flex flex-col h-screen justify-center items-center w-full relative" v-if="loading">
    <LoadingComponent />
  </div>
  <div class="flex flex-col h-full relative max-w-[425px] mx-auto w-full" v-else>
